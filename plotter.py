...
episodes, average_returns = np.load(
    "results/Namespace(ER=True, TN=False, anneal=False, num_episodes=200, eval_episodes=20, eval_interval=10, num_repetitions=5, lr=0.001, explr='egreedy 0.3', gamma=1).npy"
)
print(episodes)
...
plot.save(name="dqn-without-TN.png")
