...
def main(raw_args=None):
    ...
    argparser.add_argument("--ER", default=False, action="store_true", help="Experience Replay")
    argparser.add_argument("--TN", default=False, action="store_true", help="Target Network")
    argparser.add_argument("--anneal", default=False, action="store_true", help="annealing")
    argparser.add_argument("--num_episodes", default=200, type=int, help="training episodes")
    argparser.add_argument("--eval_episodes", default=20, type=int, help="Evaluation episodes")
    argparser.add_argument("--eval_interval", default=10, type=int, help="Evaluation Interval")
    ...
    argparser.add_argument("--explr", default="egreedy 0.3", type=str, help="Exploration Strategy")
...
def DQN_learning(env, args):
    ...
    for e in range(args.num_episodes):
        ...
        while not (episode_done or episode_truncated):
            action = agent.select_action(state, policy_str=args.explr).reshape(1, 1) # Sample action (e.g, epsilon-greedy)
